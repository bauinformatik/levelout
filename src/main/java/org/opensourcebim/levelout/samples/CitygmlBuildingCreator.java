...
public class CitygmlBuildingCreator {
    ...
    public static void main(String[] args) throws Exception {
        new CitygmlBuildingCreator().doMain();
    }
    ...
    public void doMain() throws Exception {
       ...
       geom = GeometryFactory.newInstance()
                .withIdCreator(id);
        ...
        Stream.of(ground, wall_1, wall_2, wall_3, wall_4, wall_5,wall_6,roof_1, ground2,wall_11,wall_22,wall_33,wall_44,wall_55,wall_66,roof_11)
       ...
       CityGMLVersion version = CityGMLVersion.v2_0;
        ...
        Path output = Paths.get("C:/Users/rano2746/3D Objects/levelout - github/levelout-master/output/out56.gml");
