...
public class GeodataLoGeoRef50 {
	...
	//Laut IFC 4.0.2.1 Spezifikation ist Name wie folgt beschrieben: Name by which the coordinate reference system is identified. NOTE  The name shall be taken from the list recognized by the European Petroleum Survey Group EPSG. It should then be qualified by the EPSG name space, for example as 'EPSG:5555'.
